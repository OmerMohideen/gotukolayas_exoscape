    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none">
      ...
      <g mask="url(#b)">
        <path
          className="fill-current"
          fillRule="evenodd"
          d="M11.92 3.428A3.887 3.887 0 0 0 8.039 7.31a3.873 3.873 0 0 0 3.854 3.882l.029.714v-.714A3.886 3.886 0 0 0 15.8 7.31a3.886 3.886 0 0 0-3.88-3.882Zm0 9.19h-.031a5.3 5.3 0 0 1-5.28-5.311A5.316 5.316 0 0 1 11.922 2a5.315 5.315 0 0 1 5.309 5.31 5.314 5.314 0 0 1-5.31 5.309Z"
          clipRule="evenodd"
        />
      </g>
    </svg>
